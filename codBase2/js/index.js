...
function caluloputas() {
  var a=prompt('putas muy muy caras ingrese cuanto quiere pagar el pete')
var aa=a*1.0
  var b=prompt('y ahora ingrese cuanto quiere pagar el anal')

  var bb=a*1.0

    var c=aa+bb
  alert('el costo del servicio sera:'+c+'putas muy muy caras')
}
